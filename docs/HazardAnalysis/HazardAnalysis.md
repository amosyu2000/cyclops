...
| 2023-03-22 | Aaron Li | Updated Content |

</div>

## 2. Introduction
This document is the hazard analysis of Cyclops Ride Assist (CRA) system. CRA is an all-in-one, easily mountable, and quick to setup system that adds modern car safety features onto a bicycle or motorcyle. These features include rearview detection, crash detection, and automatic video capture and upload. 
